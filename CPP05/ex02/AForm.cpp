...
/*   Updated: 2025/11/29 18:23:48 by lparolis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "AForm.hpp"

AForm::AForm() : _name("default"), _gradeToSign(75), _gradeToExec(75)
{
	DBG_MSG("AForm constructor called");
}

AForm::AForm(int gradeToSign, int gradeToExec) : _name("default"), _gradeToSign(gradeToSign), _gradeToExec(gradeToExec)
{
	DBG_MSG("AForm constructor called");
...
AForm::AForm(const AForm &obj) : _name(obj.getName()), _gradeToSign(obj.getGradeToSign()), _gradeToExec(obj.getGradeToExec())
{
...
void	AForm::execute(const Bureaucrat &executor) const
{
	if (!this->_signed)
	{
		throw FormNotSigned("This form has not been signed yet!");
		return;
	}
